<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="/dashboard"><span class="menu-title" data-i18n="">Dashboard </span></a>
                </li>
                <li class=" navigation-header"><span data-i18n="nav.category.ecommerce">Vehicles</span>
                </li>
                <li class=" nav-item"><a href="/verify"><span class="menu-title" data-i18n="">Verify a
                            Vehicle</span></a>
                </li>
                <li class=" nav-item"><a href="/reported_vehicles"><span class="menu-title" data-i18n="">View All
